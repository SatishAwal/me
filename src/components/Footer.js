...
/**
 * Footer Component
 * Displays the website footer with navigation links, social media, and contact information
 */
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Email',
      url: 'mailto:satishawal94@gmail.com',
      icon: (
   ...
   * @param {string} href - The section ID to scroll to
   */
      ...
      <div className="section-container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <p className="footer-description">
              A passionate Frontend Developer and UI/UX Designer creating 
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-bottom-content">
            <p>&copy; {currentYear} Satish Awal. All rights reserved.</p>
